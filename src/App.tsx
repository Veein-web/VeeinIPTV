    ...
    <div className="min-h-screen bg-slate-900 relative overflow-hidden" dir="rtl">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-2 sm:p-4">
        <div className="max-w-5xl w-full">
          ...
          {/* Main Card */}
          <div className="bg-slate-800/50 backdrop-blur-xl rounded-3xl p-4 sm:p-8 shadow-2xl border border-slate-700/50">
            {/* Channel Options */}
            <div className="mb-8">
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-6 text-center">اختر نوع القنوات</h2>
            ...
            <div className="text-center">
              ...
              <button
                ...
                className={`
                  ...
                  w-full max-w-xs h-14 sm:h-16 px-6 sm:px-8 py-3 sm:py-4
          ...
          {/* Instructions */}
          <div className="mt-8 bg-slate-800/30 backdrop-blur-xl rounded-2xl p-4 sm:p-6 border border-slate-700/30">
            <h3 className="text-lg sm:text-xl font-bold text-white mb-4 text-center">طريقة الاستخدام</h3>
